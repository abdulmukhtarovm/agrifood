                        ...
                        <div class="col-9">
                            <div class="fixed-nav-list d-flex justify-content-end">
                                <ul class="d-flex">
                                    ...
                                    <li><a href="contact.php" class="fix-nav__link">Продукты</a></li>
                                    <li><a href="blog.php" class="fix-nav__link">Контакты</a></li>
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li> <a href="blog.php">Контакты</a> </li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 sm-display-none">
                        <div class="address">
                            ...
                            <ul class="Links_footer">
                                ...
                                <li><i class="far fa-chevron-down"></i> <a href="blog.php">Контакты</a> </li>
